  ...
  return (
    <>
      <div className="mainFrame flex flex-col items-center p-0 gap-6 absolute left-[300px] top-[200px] w-[672px] h-[170px]">
        ...
        {/*button*/}
        <button className="buttonFrame box-border flex flex-row justify-center items-center py-1 px-5 gap-2 w-[300px] h-12 bg-[#FFFFFF] border border-solid border-[#D0D5DD] shadow-lg rounded-md">
