...
const DepartmentalPersonalTable = ({
  ...
  return (
    ...
    <div className="tableFrame flex flex-col justify-center items-center p-0 gap-3 w-[736px] h-[600px]  absolute ">
      ...
      <div className="tableAndCards box-border flex-col items-start p-0 w-full h-[90%] bg-[#FFFFFF] border border-solid border-[#EAECF0] shadow-lg rounded-lg">
        ...
        {/*card add button*/}
        <div className="addCard justify-center items-center flex w-full h-[46px] pb-1">
          <button
      ...
      {/*buttons frame*/}
      <div className="buttonsFrame flex flex-row items-start p-0 gap-3 w-full h-[8%] ">
        <button
